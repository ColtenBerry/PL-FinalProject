...
/* package PL-FinalProject-0.1.0.0 */
#ifndef VERSION_PL_FinalProject
#define VERSION_PL_FinalProject "0.1.0.0"
#endif /* VERSION_PL_FinalProject */
#ifndef MIN_VERSION_PL_FinalProject
#define MIN_VERSION_PL_FinalProject(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_PL_FinalProject */
...
#define CURRENT_COMPONENT_ID "PL-FinalProject-0.1.0.0-LKpwXaU4QoMISfM6qJXLni-set-repl"
